  ...
  return (
    <div className={`bg-white rounded-lg shadow-custom p-6 ${showPrintVersion ? 'print-version' : ''}`}>
          ...
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <a href="tel:+33665113928" className="block mt-2 text-primary font-medium flex items-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
        ...
        <Link 
          href="/" 
          className="py-2 px-4 bg-primary text-white rounded-md font-medium hover:bg-primary-dark hover:text-white transition-colors duration-300 flex items-center justify-center"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
