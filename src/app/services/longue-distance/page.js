...
export const metadata = {
  title: 'Services de trajet longue distance | Taxi VLB',
  description: 'Service de taxi pour vos trajets longue distance au départ de Verrières-le-Buisson. Voyagez en toute sérénité vers les grandes villes françaises et européennes.',
  keywords: 'taxi longue distance, trajet inter-villes, voyage taxi, transfert ville à ville, Verrières-le-Buisson',
};
    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-80 md:h-96 flex items-center justify-center text-white text-center overflow-hidden" 
        ...
        <div className="relative z-10 px-4 max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate-slide-in-left">TRAJETS LONGUE DISTANCE</h1>
          ...
          <p className="text-lg max-w-3xl mx-auto animate-slide-in-right">
            Service de taxi confortable pour vos trajets interurbains
          </p>
        </div>
      </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-10">
              ...
              <p className="text-lg text-center text-gray-600 mb-8">
                Des trajets longue distance adaptés à tous vos besoins
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-600">Départ à l'heure qui vous convient, sans contrainte d'horaire imposé.</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-600">WiFi gratuit et prises de recharge pour rester connecté durant votre trajet.</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 hover:shadow-md transition-all duration-300">
                ...
                <p className="text-gray-600">Possibilité de faire des pauses ou des arrêts intermédiaires selon vos besoins.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-center text-gray-600 mb-12">
            Nos trajets les plus fréquents avec estimation de tarifs
          </p>
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-center text-gray-600 mb-12">
            Témoignages de clients ayant utilisé notre service longue distance
          </p>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex items-start bg-white p-6 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Pas de mauvaises surprises avec notre tarification claire et transparente, établie à l'avance.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white p-6 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Pas de détours ni d'arrêts multiples. Nous vous conduisons directement à votre destination.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white p-6 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Idéal pour les voyages d'affaires, nos chauffeurs garantissent votre tranquillité et votre confidentialité.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-white p-6 rounded-lg shadow-md">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Évitez les temps d'attente en gare ou à l'aéroport et optimisez votre temps de trajet.
                </p>
              </div>
            </div>
          </div>
      ...
      <div id="booking" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4 text-center uppercase">RÉSERVEZ VOTRE TRAJET</h2>
          <p className="text-lg text-center text-gray-600 mb-12">
      ...
      {/* FAQ Section - Nouveauté */}
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-4 text-center uppercase">QUESTIONS FRÉQUENTES</h2>
          <p className="text-lg text-center text-gray-600 mb-12">
            Tout ce que vous devez savoir sur nos services longue distance
          </p>
          
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-primary"></div>
              <h3 className="text-lg font-semibold mb-2 pl-4">Est-il possible de faire des arrêts pendant le trajet ?</h3>
              <p className="text-gray-600 pl-4">
                Oui, nous pouvons prévoir des arrêts pendant votre trajet longue distance. Il suffit de nous en informer lors de votre réservation.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 relative overflow-hidden">
              ...
              <p className="text-gray-600 pl-4">
                Le prix est calculé en fonction de la distance, de la durée estimée du trajet, du nombre de passagers et de bagages. Nous vous fournissons un devis précis avant votre confirmation.
              </p>
            </div>
            
            <div className="bg-white rounded-lg shadow-md p-6 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-primary"></div>
              <h3 className="text-lg font-semibold mb-2 pl-4">Peut-on réserver pour un trajet le jour même ?</h3>
              <p className="text-gray-600 pl-4">
                Oui, sous réserve de disponibilité. Toutefois, pour les trajets longue distance, nous recommandons de réserver au moins 24 heures à l'avance pour garantir la disponibilité.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 relative overflow-hidden">
              ...
              <p className="text-gray-600 pl-4">
                Absolument. Nos chauffeurs sont expérimentés et spécifiquement formés pour les trajets longue distance, connaissant les meilleures routes et garantissant votre sécurité et confort.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-12 bg-dark text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-3xl mx-auto">
            Contactez-nous pour obtenir un devis adapté à votre itinéraire
          </p>
